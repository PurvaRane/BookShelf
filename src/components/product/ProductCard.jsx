  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[3/4] bg-[#FAF7F3] p-4 flex items-center justify-center overflow-hidden border-b border-[#E3DDD6]">
        ...
        >
          <svg 
            className={`w-5 h-5 transition-colors ${inWishlist ? 'fill-[#5B2C2C] text-[#5B2C2C]' : 'fill-none text-[var(--color-text-faint)] hover:text-[#5B2C2C]'}`} 
            viewBox="0 0 24 24" 
            stroke="currentColor" 
            strokeWidth={1.5}
          >
      ...
      <div className="p-4 flex flex-col flex-grow bg-white">
        ...
        {/* Title */}
        <h3 className="font-serif text-base text-[var(--color-text-main)] leading-snug mb-1 line-clamp-2 group-hover:text-[#5B2C2C] transition-colors">
          {title}
        </h3>
        ...
        {/* Bottom Metadata */}
        <div className="mt-auto flex items-end justify-between border-t border-[var(--color-paper-border)] pt-3">
          <div className="flex flex-col">
            <span className="text-lg font-serif text-[var(--color-success)] font-medium">
              {formatPrice(price)}
            </span>
             <div className="flex items-center gap-1 mt-0.5 opacity-60">
              ...
              <span className="text-[10px] text-[var(--color-text-muted)] font-medium">{rating}</span>
            </div>
          </div>
